...
public class hiraganaUI extends javax.swing.JFrame {
    ...
    public  hiraganaUI() {
        ...
        initComponents();
        Image img = new ImageIcon(this.getClass().getResource("assets/jpnFlag"  + ".png")).getImage();
        this.setIconImage(img);
        
        jLabel1.setText(h.getTAnswer());
...
if (nA == 0) {
    ...
    private void initComponents() {
        ...
        jPopupMenu1.setPreferredSize(new java.awt.Dimension(200, 200));
